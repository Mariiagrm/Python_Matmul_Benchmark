...
# --- 1. CONFIGURACIÓN EXTREMA DEL ENTORNO Y HARDWARE (TF32) ---
device = torch.device("cuda")

# Optimizaciones de backend para RTX 4090 (Ada Lovelace) — modo TF32.
# Entradas FP32 pero los Tensor Cores hacen el producto en TF32.
...
# --- KERNEL TRITON SIMPLE (TF32) ---
# Entradas FP32, acumulación FP32 y tl.dot con allow_tf32=True para
# que use Tensor Cores en modo TF32.
@triton.jit
...
def run_benchmarks(custom_tasks=None):
    ...
    print(f"🚀 Modo: torch.compile(max-autotune, fullgraph=True, dynamic=False) — TF32")
...
if __name__ == "__main__":
    ...
    if save:
        ...
        filename = results_dir / "rtx4090_benchmark_jit_tf32.csv"
