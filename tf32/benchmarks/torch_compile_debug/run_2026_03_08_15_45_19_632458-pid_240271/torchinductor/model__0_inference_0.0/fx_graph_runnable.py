...
def load_args(reader):
    buf0 = reader.storage(None, 536870912, device=device(type='cuda', index=0), dtype_hint=torch.float16)
    reader.tensor(buf0, (16384, 16384), dtype=torch.float16, is_leaf=True)  # arg0_1
    buf1 = reader.storage(None, 536870912, device=device(type='cuda', index=0), dtype_hint=torch.float16)
    reader.tensor(buf1, (16384, 16384), dtype=torch.float16, is_leaf=True)  # arg1_1
