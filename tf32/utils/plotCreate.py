...
if not dataframes:
    ...
    for mode in modes:
        ...
        plt.axhline(y=82.6, color='red', linestyle='--', linewidth=1.5, label='Theoretical Peak (82.6 TFLOPS)')

        plt.title(f'Throughput (TFLOPS) MatMul (TF32) - RTX 4090 - Mode: {mode}', fontsize=16, pad=15)
