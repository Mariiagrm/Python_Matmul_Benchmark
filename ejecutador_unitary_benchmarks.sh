...
python unitary_benchmarks/benchmark_aot_compile.py
echo "✅ Completado: AOT Compile"
echo "--------------------------------------------------------"

echo "▶️  Ejecutando: FP16 Benchmark"
python unitary_benchmarks/benchmark_fp16_fp16.py
...
python unitary_benchmarks/benchmark_torch_compile.py
