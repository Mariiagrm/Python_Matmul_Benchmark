...
archivos_csv = [
    "../results/rtx4090_benchmark_jit_specific.csv",
    "../results/rtx4090_pytorch_eager_specific.csv",
...
nombres_metodos = {
    "../results/rtx4090_benchmark_jit_specific.csv": "Torch JIT",
    "../results/rtx4090_pytorch_eager_specific.csv": "PyTorch Eager",
    "../results/rtx4090_torch_aoti_benchmark.csv": "Torch AOTI",
    "../results/rtx4090_benchmark_cuda.csv": "CUDA Nativo"
}
...
if not dataframes:
    ...
    for modo in modos:
        ...
        nombre_archivo_salida = f"../plots/comparativa_tflops_{modo.lower()}.png"
